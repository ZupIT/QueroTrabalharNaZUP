...
- Proponha e codifique a solução em linguagem Java.
- Crie testes unitátios para os serviços.
- Faça um *pull request* da sua solução neste repositório.

###Atenção:
Serão avalidados: organização do código, simplicidade da solução (KISS), aplicação dos conceitos de orientação a objetos, cobertura de testes, extensibilidade, manutenibilidade.
